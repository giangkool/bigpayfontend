    ...
    .config([
        ...
        function ($stateProvider, $urlRouterProvider) {
            ...
            // -- DASHBOARD --
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                'app/components/topup/topupController.js',
                                'app/components/billpayment/billpaymentController.js',
                                'app/components/prepaid/prepaidController.js'
                            ]);
                        }],
                ...
                .state("restricted.topup", {
                    url: "/topup",
                    templateUrl: 'app/components/topup/topupView.html',
                    ...
                    data: {
                        pageTitle: 'Nạp tiền điện tử'
                    }
                })

                .state("restricted.ewallet", {
                    url: "/ewallet",
                    templateUrl: 'app/components/ewallet/ewallet.html',
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                ...
                                //'lazy_google_maps',
                                'lazy_clndr',
                                'app/components/ewallet/ewalletController.js'
                            ]);
                        }]
                    },
                    data: {
                ...
                .state("restricted.prepaid", {
                    url: "/prepaid",
                    templateUrl: 'app/components/prepaid/prepaidView.html',
                ...
                .state("restricted.billpayment", {
                    url: "/billpayment",
                    templateUrl: 'app/components/billpayment/billpaymentView.html',
